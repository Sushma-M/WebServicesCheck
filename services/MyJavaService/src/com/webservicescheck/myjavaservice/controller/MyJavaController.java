 ...
 */
package com.webservicescheck.myjavaservice.controller;

import com.webservicescheck.myjavaservice.MyJavaService;
...
public class MyJavaController {
    ...
    @RequestMapping(value = "/sampleTest/{a}/{b}", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "")
    public int sampleTest(@PathVariable("a") int a, @PathVariable("b") int b) {
        return myJavaService.sampleTest(a, b);
    }
}
