...
import com.webservicescheck.leavedb.service.LeaveDBQueryExecutorService;

@RestController(value = "LeaveDB.QueryExecutionController")
@RequestMapping("/leaveDB/queryExecutor")
...
public class QueryExecutionController {
    ...
    @Autowired
    private LeaveDBQueryExecutorService queryService;
    ...
    public Page<EmpDetails> executeTestQuery(Pageable pageable, HttpServletRequest _request) {
        LOGGER.debug("Executing named query: testQuery");
        Page<EmpDetails> _result = queryService.executeTestQuery(pageable);
