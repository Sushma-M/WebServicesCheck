...
public class Calculator extends Service {
    ...
    static {
        URL url = Calculator.class.getResource("calc.wsdl");
        if (url == null) {
            url = Calculator.class.getClassLoader().getResource("calc.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(Calculator.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "calc.wsdl");
        }       
        WSDL_LOCATION = url;
    }
